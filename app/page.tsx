...
<h1 className="text-5xl sm:text-6xl md:text-7xl font-bold mt-6 tracking-tight bg-gradient-to-r from-white via-cyan-300 to-blue-400 bg-clip-text text-transparent">
  Saransh Mishra
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <a href="/resume.pdf" target="_blank" className="rounded-2xl bg-gradient-to-r from-cyan-400 via-sky-400 to-blue-500 px-6 py-3 text-sm font-semibold text-slate-950 shadow-lg shadow-cyan-400/30 transition hover:scale-[1.04] hover:shadow-cyan-400/50">View Resume</a>
